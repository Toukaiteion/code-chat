...
| **M7c** | **压缩**：`compaction-service.ts` + 阈值 + 确定性摘要 + `inject_mode` 的消费（2026-09-24 落地） | `1d54173` |
...
> M7c 是**单独一个** commit（`1d54173`），但它**一并收口了三块的文档**（M7a 的收口
> 是拍板并入本轮的）—— 与其在文档里编一条「哪些段落属于哪个里程碑」的分界，不如说明白。
